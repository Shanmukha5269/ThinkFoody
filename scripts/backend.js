...
//     // const prompt = `List the ingredients for a ${recipeName} recipe with quantities and units (e.g., "2 cups of flour", "1 tablespoon of oil").`;
//     // Enhanced AI prompt suggestion
//     const prompt = `List ingredients with exact quantities and units. 
//     Include density information where available: 
//     "2 cups (240g) flour, 1 tablespoon (14.7g) butter..."`;
//     const response = await axios.post(
//       'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent',
//       {
//         contents: [{ parts: [{ text: prompt }] }],
